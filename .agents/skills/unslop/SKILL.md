...
23. **Forks.** Never call a choice a "fork" or turn it into an unsolicited design review. If consequences were requested, add one plain consequence after each option. Do not recommend a choice unless asked. 

Example: "Options: a) Await a logging call after each step. May result in degraded throughput. b) Emit step events and log them from a listener. Decoupled, more machinery. Which way?"
...
### Jargon
27. **Abstract metaphor nouns.** Substrate, wedge, vector, locus, vantage, nexus, primitive (as noun), harness (as metaphor), surface (as in "API surface"), bedrock, scaffolding (as metaphor), modality, paradigm, gold-plating, ratchet (as metaphor), evacuate (for moving code), endgame, north star, flywheel, load-bearing. These read as technical but usually have a plainer concrete word. "Substrate" becomes "base". "Wedge in" becomes "add". "Vector" becomes "way" or "method".
"Gold-plating" becomes "more than the job needs". "Ratchet" becomes the mechanism's real name or "a limit that only tightens". "Evacuate" becomes "move out". "Endgame" becomes "the last phase". Replace "This spreadsheet is load-bearing" with the actual dependency: "The payroll import fails without this spreadsheet." Pick the concrete word.
### Plain speech
...
Adapted with appreciation from Lauren Tan's [`unslop`](https://github.com/cursor/plugins/tree/main/pstack/skills/unslop) skill in the pstack plugin. Distributed under the MIT License included with this skill.
